...
![alt text](https://github.com/GreggA1/RepData_Assignment1/blob/master/figures_1/RplotdailyStepsvsFrequencyperDay.png)
...
##This displays the graph:
![alt text](https://github.com/GreggA1/RepData_Assignment1/blob/master/figures_1/RplotDailyActivityPattern.png)
...
##This displays the graph:
![alt text](https://github.com/GreggA1/RepData_Assignment1/blob/master/figures_1/RplotdailyStepsvsFrequencyperDayFilled.png)
...
##This displays the graph:
![alt text](https://github.com/GreggA1/RepData_Assignment1/blob/master/figures_1/RplotdayType%20Comparison.png)
